   ...
   function submitForm1()
   {
      ...
      {
         regexp = /^[A-Za-zАБВГДЕЖЗИЙКЛМНОПРСТУФХЧЦШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя \t\r\n\f0-9-]*$/;
      ...
      {
         regexp = /^[A-Za-zАБВГДЕЖЗИЙКЛМНОПРСТУФХЦШЩЧЪЫЬЭЮЯабвгдежзийклмнопрстуфхцшчщъыьэюя \t\r\n\f0-9-]*$/;
